...
<body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand fw-bold" href="/TugasBesar_KelompokC">Tugas Besar - Kelompok C</a>
    ...
    <div class="bg">
        <div class="container min-vh-100 d-flex align-items-center">
            <div class="pt-5 mt-4">
                <h2 class="text-center align-middle text-white"><b class="bg-dark"> Welcome to Atma Jaya Library</b></h2>
            </div>
        </div>
    </div>
